...
namespace PH2.BLL
{
    internal class GV_XemDangKyBLL
    {
        private GV_XemDangKyDAL XemDangKyDAL;
        public GV_XemDangKyBLL()
        {
            XemDangKyDAL = new GV_XemDangKyDAL();
        }
        public List<GV_XemDangKyDTO> GetDangKyGV()
        {
            DataTable dt = XemDangKyDAL.GetDangKyGV();
            List<GV_XemDangKyDTO> danhSach = Utility.ToList<GV_XemDangKyDTO>(dt);
            return danhSach;
        }
