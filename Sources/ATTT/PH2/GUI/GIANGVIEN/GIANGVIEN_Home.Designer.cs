namespace PH2.GUI
{
    partial class GIANGVIEN_Home
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 22.57336F));
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0609484F));
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0609484F));
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0609484F));
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0609484F));
            tableSidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 11.0609484F));
            ...
            DangKyBtn.Location = new Point(3, 510);
            ...
            PhanCongBtn.Location = new Point(3, 438);
            ...
            logoutBtn.Location = new Point(87, 108);
            ...
            DSSinhVienBtn.Location = new Point(3, 150);
            ...
            DSDonViBtn.Location = new Point(3, 222);
            ...
            KHMOBtn.Location = new Point(3, 366);
            ...
            DeTaiNCBtn.Location = new Point(3, 582);
            DeTaiNCBtn.Name = "DeTaiNCBtn";
            DeTaiNCBtn.Size = new Size(263, 67);
