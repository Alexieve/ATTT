CREATE OR REPLACE PROCEDURE USP_GET_PHAN_CONG_TRUONGDV(P_RES OUT SYS_REFCURSOR)
AS
BEGIN
    OPEN P_RES FOR
        WITH CTE AS
    (
      SELECT MANV, HOTEN FROM NHANSU
        ...
        ON PC.MAHP = HP.MAHP JOIN CTE ON PC.MAGV = CTE.MANV;
END;
/
GRANT EXECUTE ON USP_GET_PHAN_CONG_TRUONGDV TO RL_TRUONGDV;
