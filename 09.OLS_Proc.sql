...
UPDATE C##ADMIN.THONGBAO SET BRANCH_LABEL = CHAR_TO_LABEL('BRANCH_POLICY', 'TRUONGDV:VPK,HTTT,CNPM,KHMT,CNTT,TGMT,MMT:CS1,CS2') WHERE NGAY = '04-01-2024';
...
EXECUTE SA_POLICY_ADMIN.REMOVE_TABLE_POLICY('BRANCH_POLICY','C##ADMIN','THONGBAO');
EXECUTE SA_POLICY_ADMIN.APPLY_TABLE_POLICY (policy_name => 'BRANCH_POLICY', schema_name => 'C##ADMIN', table_name => 'THONGBAO', table_options => 'READ_CONTROL',predicate => NULL); 