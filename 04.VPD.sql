...
BEGIN
    ...
    ELSIF IS_ROLE_SUBROLE(P_USER_ROLE, 'RL_TRUONGDV') = 'RL_TRUONGDV' THEN
        RETURN '1 = 1';
    ELSIF IS_ROLE_SUBROLE(P_USER_ROLE, 'RL_GIAOVU') = 'RL_GIAOVU' THEN
        RETURN '1 = 1';
...
-- CS2.3
CREATE OR REPLACE FUNCTION POL_FUNC_CURRENT_GIANGVIEN_DANGKY_SELECT (
    P_SCHEMA IN VARCHAR2, 
    P_OBJECT IN VARCHAR2
)
RETURN VARCHAR2
...
BEGIN
    DBMS_RLS.DROP_POLICY(
        OBJECT_SCHEMA => 'C##ADMIN',
        OBJECT_NAME => 'DANGKY',
        POLICY_NAME => 'POL_DANGKY_CURRENT_GIANGVIEN_SELECT'
    );
END;
/
BEGIN
    DBMS_RLS.ADD_POLICY(
        ...
        OBJECT_NAME => 'DANGKY',
        POLICY_NAME => 'POL_DANGKY_CURRENT_GIANGVIEN_SELECT',
        POLICY_FUNCTION => 'POL_FUNC_CURRENT_GIANGVIEN_DANGKY_SELECT',
        STATEMENT_TYPES => 'SELECT'
    );
END;
/
CREATE OR REPLACE FUNCTION POL_FUNC_CURRENT_GIANGVIEN_DANGKY_UPDATE (
    P_SCHEMA IN VARCHAR2, 
    P_OBJECT IN VARCHAR2
)
RETURN VARCHAR2
...
BEGIN
    DBMS_RLS.DROP_POLICY(
        OBJECT_SCHEMA => 'C##ADMIN',
        OBJECT_NAME => 'DANGKY',
        POLICY_NAME => 'POL_DANGKY_CURRENT_GIANGVIEN_UPDATE'
    );
END;
/
BEGIN
    DBMS_RLS.ADD_POLICY(
        ...
        OBJECT_NAME => 'DANGKY',
        POLICY_NAME => 'POL_DANGKY_CURRENT_GIANGVIEN_UPDATE',
        POLICY_FUNCTION => 'POL_FUNC_CURRENT_GIANGVIEN_DANGKY_UPDATE',
...
BEGIN
    ...
    IF (IS_ROLE_SUBROLE(P_USER_ROLE, 'RL_TRUONGDV') = 'RL_TRUONGDV' or IS_ROLE_SUBROLE(P_USER_ROLE, 'RL_GIAOVU') = 'RL_GIAOVU') THEN
        RETURN 'MANV = ''' || SYS_CONTEXT('USERENV', 'SESSION_USER') || '''';
    ELSE
        RETURN '1 = 1';
    END IF;
